...
function LoginForm() {
  ...
  function handleGoogleClick() {
    ...
    // Reset loading after a moment if GIS prompt was shown (it's a popup)
        ...
        <div className="rounded-2xl border border-border/50 bg-white p-8 shadow-lg">
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary-dark hover:-translate-y-0.5 active:translate-y-0 active:shadow-md disabled:opacity-50 disabled:hover:translate-y-0"
            >
              {loading ? (
                <>
          ...
          <button
            ...
            disabled={googleLoading || loading || !process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID?.trim()}
            className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-white px-4 py-3 text-sm font-medium text-foreground shadow-sm transition-all hover:bg-background hover:-translate-y-0.5 active:translate-y-0 active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
              <>
