        ...
        <div className="rounded-2xl border border-border/50 bg-white p-8 shadow-lg">
          ...
          {process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID?.trim() ? (
            ...
            <button
              type="button"
              disabled
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-white px-4 py-3 text-sm font-medium text-muted cursor-not-allowed opacity-50"
            >
